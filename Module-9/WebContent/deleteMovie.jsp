<%--
    ...
    Purpose: Displays all movie records in a table format and a dropdown list
             for selecting a record to delete.
--%>
...
<p>Select a movie ID to delete. After deletion, the page will refresh showing the remaining movies.</p>
...
<table border="1" cellpadding="5" cellspacing="0">
    ...
    %>
        <tr>
            <td colspan="6" style="text-align:center;">No movie records remain.</td>
        </tr>
    <%
        } else {
            for (Movie m : movies) {
