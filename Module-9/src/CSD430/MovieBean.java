/*
    Author: Crystal Long
    Date: 12/03/2025
    Assignment: Modules 5, 6, 7, 8, & 9 - Project Parts 1–4
...
public class MovieBean {
    ...
    // ------------------------------------------------------------
    //  INSERT a new movie record (CREATE)
    // ------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    //  UPDATE an existing movie record (Module 8)
    // ------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    //  DELETE a movie by ID (Module 9)
    // ------------------------------------------------------------
    public void deleteMovie(int id) {

        String sql = "DELETE FROM crystal_movies_data WHERE movie_id = ?";
